...
CREATE TABLE `doctorslog` (
  ...
  `status` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)/*,
  FOREIGN KEY (uid) REFERENCES doctors(id)*/
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `tblpatientlog` (
  ...
  `status` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)/*,
  FOREIGN KEY (uid) REFERENCES tblpatient(ID)*/
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `appointment` (
  ...
  FOREIGN KEY (userId) REFERENCES tblpatient(ID)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `tbltestresult` (
  ...
  `CreationDate` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
  FOREIGN KEY (MHID) REFERENCES tblmedicalhistory(ID),
  FOREIGN KEY (PatientID) REFERENCES tblpatient(ID)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE Stay (
  ...
  FOREIGN KEY (Patient) REFERENCES tblpatient(ID)*/
);
...
LOCK TABLES 
    ...
    department WRITE,
    doctorpatient WRITE,
    doctorspecilization WRITE,
    tblmedicalhistory WRITE,
    tbltestresult WRITE,
     WRITE,
     WRITE,
    appointment WRITE;*/
...
ALTER TABLE `doctorslog` AUTO_INCREMENT=27;
...
DROP TRIGGER IF EXISTS on_patient_deregister;
DELIMITER $$
CREATE TRIGGER on_patient_deregister 
            BEFORE DELETE ON tblpatient 
FOR EACH ROW
BEGIN
  DELETE FROM appointment WHERE userId = OLD.ID;
  DELETE FROM images WHERE patientid = OLD.ID;
  DELETE FROM tbltestresult WHERE PatientID = OLD.ID;
  DELETE FROM tblmedicalhistory WHERE PatientID = OLD.ID;
  DELETE FROM doctorpatient WHERE patientid = OLD.ID;
END $$
DELIMITER ;


DROP TRIGGER IF EXISTS on_doctor_deregister;
DELIMITER $$
CREATE TRIGGER on_doctor_deregister 
            BEFORE DELETE ON doctors 
FOR EACH ROW
BEGIN
  DELETE FROM appointment WHERE doctorId = OLD.id;
  DELETE FROM doctorpatient WHERE doctorId = OLD.id;
END $$
DELIMITER ;
...
(1, 'admin1@gmail.com', 'Test@123', '30-10-2022 11:42:05 AM');

INSERT INTO `users` (`id`, `fullName`,`usertype`, `email`, `password`, `regDate`, `updationDate`) VALUES
(1, 'Dinesh karhik',  'frontdesk','dinesh@test.com', 'f925916e2754e5e03f75dd58a5733251', '2022-11-06 12:13:56', NULL),
(2, 'Dasari Giridhar', 'dataentry', 'giridhar@gmail.com', 'f925916e2754e5e03f75dd58a5733251', '2022-11-06 13:15:32', NULL);

INSERT INTO `userlog` (`id`, `uid`, `username`, `userip`, `loginTime`, `logout`, `status`) VALUES
(1, 1, 'dinesh@test.com', 0x3a3a3100000000000000000000000000, '2022-11-06 12:14:11', NULL, 1),
(2, 1, 'dinesh@test.com', 0x3a3a3100000000000000000000000000, '2022-11-06 12:21:20', '06-11-2022 05:53:00 PM', 1),
(3, NULL, 'giridhar@gmail.com', 0x3a3a3100000000000000000000000000, '2022-11-06 13:15:43', NULL, 0),
(4, 2, 'giridhar@gmail.com', 0x3a3a3100000000000000000000000000, '2022-11-06 13:15:58', '06-11-2022 06:50:46 PM', 1);
...
(1, 'ENT', 'Tharakeswar', 'A 123 XYZ Apartment Raj Nagar Ext Ghaziabad', '500', 142536250, 'tharak@gmail.com', 'f925916e2754e5e03f75dd58a5733251', '2022-10-30 18:16:52', '2022-11-06 13:20:17'),
(2, 'Endocrinologists', 'Karamcheti vamsy', 'X 1212 ABC Apartment Laxmi Nagar New Delhi ', '800', 1231231230, 'vamsy@gmail.com', 'f925916e2754e5e03f75dd58a5733251', '2022-11-04 01:06:41', NULL);


INSERT INTO `doctorslog` (`id`, `uid`, `username`, `userip`, `loginTime`, `logout`, `status`) VALUES
(20, NULL, 'gfdgdf', 0x3a3a3100000000000000000000000000, '2022-11-04 01:02:16', NULL, 0),
(21, 2, 'vamsy@gmail.com', 0x3a3a3100000000000000000000000000, '2022-11-06 11:59:40', '06-11-2022 05:35:18 PM', 1),
(22, 2, 'vamsy@gmail.com', 0x3a3a3100000000000000000000000000, '2022-11-06 12:06:37', '06-11-2022 05:36:40 PM', 1),
(23, 2, 'vamsy@gmail.com', 0x3a3a3100000000000000000000000000, '2022-11-06 12:08:56', '06-11-2022 05:42:53 PM', 1),
(24, 1, 'tharak@gmail.com', 0x3a3a3100000000000000000000000000, '2022-11-06 12:23:18', '06-11-2022 05:53:40 PM', 1),
(25, 2, 'vamsy@gmail.com', 0x3a3a3100000000000000000000000000, '2022-11-06 13:16:53', '06-11-2022 06:47:07 PM', 1),
(26, 1, 'tharak@gmail.com', 0x3a3a3100000000000000000000000000, '2022-11-06 13:17:33', '06-11-2022 06:50:28 PM', 1);
...
(1, 'patient1', 1231231230, 'patient1@gmail.com', 'male', 'New Delhi india', 35, 'NA', '2022-11-06 13:18:31', NULL);
...
(20, NULL, 'gfdgdf', 0x3a3a3100000000000000000000000000, '2022-11-04 01:02:16', NULL, 0),
(21, 2, 'patient1@gmail.com', 0x3a3a3100000000000000000000000000, '2022-11-06 11:59:40', '06-11-2022 05:35:18 PM', 1),
(22, 2, 'patient1@gmail.com', 0x3a3a3100000000000000000000000000, '2022-11-06 12:06:37', '06-11-2022 05:36:40 PM', 1),
(23, 2, 'patient1@gmail.com', 0x3a3a3100000000000000000000000000, '2022-11-06 12:08:56', '06-11-2022 05:42:53 PM', 1),
(24, 1, 'patient1@gmail.com', 0x3a3a3100000000000000000000000000, '2022-11-06 12:23:18', '06-11-2022 05:53:40 PM', 1);
...
(1, 'Tharakeswar', 1, '80/120', '120', '85', '98', 'Test', '2022-11-06 13:19:41');
